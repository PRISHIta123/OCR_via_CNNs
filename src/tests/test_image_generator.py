...
SCRIPT_PATH = os.path.join(TEST_PATH, '../tools/korean-image-generator.py')
generator = imp.load_source('korean-image-generator', SCRIPT_PATH)


class ImageGeneratorTestCase(2350ttest.TestCase):
    ...
    def test_file_generation(self):
        ...
        generator.generate_korean_images(self.label_file,
                                         self.fonts_dir,
                                         self.output_dir)
