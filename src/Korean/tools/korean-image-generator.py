...
def generate_korean_images(label_file, fonts_dir, output_dir):
    """Generate korean image files.
    ...
    image_dir = os.path.join(output_dir, 'korean-images')
    ...
    for character in labels:
        ...
        for font in fonts:
            ...
            file_string = 'korean_{}.jpeg'.format(total_count)
...
if __name__ == '__main__':
    ...
    generate_korean_images(args.label_file, args.fonts_dir, args.output_dir)
