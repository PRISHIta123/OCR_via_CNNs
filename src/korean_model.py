...
def main(label_file, tfrecords_dir, model_output_dir, num_train_steps):
    ...
    # Third convolutional layer. 72 feature maps.
    W_conv3 = weight_variable([3, 3, 64, 72])
    b_conv3 = bias_variable([72])
    ...
    h_pool_flat = tf.reshape(h_pool3, [-1, 8*8*72])
    W_fc1 = weight_variable([8*8*72, 1024])
